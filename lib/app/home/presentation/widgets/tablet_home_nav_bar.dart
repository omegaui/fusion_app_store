...
class TabletHomeNavBar extends StatefulWidget {
  const TabletHomeNavBar({super.key, required this.scrollController});

  final ScrollController scrollController;

  @override
  State<TabletHomeNavBar> createState() => _TabletHomeNavBarState();
}

class _TabletHomeNavBarState extends State<TabletHomeNavBar> {
  bool hover = false;
