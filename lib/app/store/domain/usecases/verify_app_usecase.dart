...
class VerifyAppUseCase extends CompletableUseCase<AppEntity> {
  final StoreRepository _repository;

  VerifyAppUseCase(this._repository);

  @override
  Future<Stream<void>> buildUseCaseStream(AppEntity? params) async {
    StreamController<void> controller = StreamController();
    try {
      controller.add(await _repository.verifyApp(appEntity: params!));
    } catch (e) {
