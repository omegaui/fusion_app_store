...
class CreateAppWizard extends StatefulWidget {
  const CreateAppWizard({
    super.key,
  ...
  @override
  State<CreateAppWizard> createState() => _CreateAppWizardState();
  ...
  static Future<void> open(
    ...
    await Get.dialog(
      CreateAppWizard(controller: controller, state: state),
...
class _CreateAppWizardState extends State<CreateAppWizard> {
  ...
  List<SystemRequirements> systemRequirements = [
    SystemRequirements(
        type: SystemRequirementsType.minimum,
        ram: "",
        cpu: "",
        architecture: "",
        additional: {}),
    SystemRequirements(
        type: SystemRequirementsType.recommended,
        ram: "",
        cpu: "",
        architecture: "",
        additional: {}),
  ...
  void initState() {
    super.initState();
    appEntity = AppEntity.empty(
      maintainer: widget.state.userEntity.username,
      packageID: '',
    );
  }
                        ...
                        child: SizedBox(
                          ...
                          child: _textField(
                            ...
                            validator: (value) {
                              ...
                              if (widget.state.ownedApps
                                  .any((app) => app.packageID == value)) {
                                return '*Package ID already taken';
                              }
                              return null;
                            },
                          ),
